...
final class Package implements IPackage
{
    ...
    protected function __construct($vendor, $project, array $developmentPaths, array $additionalPaths = null, $projectRoot = null, ISemVer $version = null, $enableDebug = null, $enableCache = null, array $loaderClassNames = null)
    {
        $this->vendor = $vendor;
